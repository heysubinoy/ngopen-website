          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-zinc-400">
                Comprehensive guide to installing, configuring, and using ngopen
            ...
            <div className="space-y-6">
              <div className="space-y-2">
                ...
                <p className="text-zinc-400">
                  ngopen is a self-hosted reverse tunneling and HTTP exposure
                  service. This guide will help you get started with
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-4">
                <div className="rounded-lg border border-zinc-800 p-4">
                  ...
                  <p className="text-sm text-zinc-400">
                    ngopen creates a secure tunnel between your local machine
                    and the ngopen server. When a request comes to the public
                    URL, it's forwarded through this tunnel to your local
                    service. This allows external access to services running on
                    your local machine without requiring you to open ports in
                ...
                <div className="rounded-lg border border-zinc-800 p-4">
                  ...
                  <p className="text-sm text-zinc-400">
                    Unlike other tunneling services, ngopen is designed to be
                    self-hosted. This means you have complete control over your
                    data and can customize the service to your needs. You can
                    run ngopen on your own server, in a Docker container, or on
                    a cloud provider.
                  </p>
                </div>
                ...
                <div className="rounded-lg border border-zinc-800 p-4">
                  ...
                  <p className="text-sm text-zinc-400">
                    When exposing local services to the internet, security is
                    paramount. ngopen provides TLS encryption, authentication
                    options, and access controls to help you secure your
                    tunnels. Always be mindful of what services you expose and
              ...
              <div className="space-y-2">
                <div className="rounded-md bg-zinc-900 p-3">
                  <div className="font-mono text-sm">
                    ...
                    - Initialize a new ngopen server
                  </div>
                </div>
                ...
                <div className="rounded-md bg-zinc-900 p-3">
                  <div className="font-mono text-sm">
                    <span className="text-emerald-400">
                      ngopen config [get|set] [KEY] [VALUE]
                    </span>{" "}
                ...
                <div className="rounded-md bg-zinc-900 p-3">
                  <div className="font-mono text-sm">
                    <span className="text-emerald-400">ngopen --help</span> -
